...
import Login2 from "../pages/login/registernew";
...
const CombinedDashboard = React.lazy(
  () => import("../admin-app/pages/AccountStatement/CombinedDashboard")
);
const AssignAgent = React.lazy(
  () => import("../admin-app/pages/admin-dashboard/assign-agent")
);
const MultiLogin = React.lazy(
  () => import("../admin-app/pages/admin-dashboard/multi-login")
);
const SecureAuth = React.lazy(
  () => import("../admin-app/pages/admin-dashboard/secure-auth")
);
